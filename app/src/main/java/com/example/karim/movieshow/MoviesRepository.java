...
public class MoviesRepository {
    ...
    public void getMovies(int page,String sortBy,final OnGetMoviesCallback callback) {
        ...
        switch (sortBy) {
            case TOP_RATED:
                api.getTopRatedMovies(BuildConfig2.TMDB_API_KEY, LANGUAGE, page)
                        .enqueue(call);
                break;
            case UPCOMING:
                api.getUpcomingMovies(BuildConfig2.TMDB_API_KEY, LANGUAGE, page)
                        .enqueue(call);
                break;
            case POPULAR:
            default:
                api.getPopularMovies(BuildConfig2.TMDB_API_KEY, LANGUAGE, page)
                        .enqueue(call);
                break;
        }
    ...
    public void getMovie(int movieId, final OnGetMovieCallback callback) {
        api.getMovie(movieId, BuildConfig2.TMDB_API_KEY, LANGUAGE)
    ...
    public void getGenres(final OnGetGenresCallback callback) {
        api.getGenres(BuildConfig2.TMDB_API_KEY, LANGUAGE)
    ...
    public void getTrailers(int movieId, final OnGetTrailersCallback callback) {
        api.getTrailers(movieId, BuildConfig2.TMDB_API_KEY, LANGUAGE)
    ...
    public void getReviews(int movieId, final OnGetReviewsCallback callback) {
        api.getReviews(movieId, BuildConfig2.TMDB_API_KEY, LANGUAGE)
