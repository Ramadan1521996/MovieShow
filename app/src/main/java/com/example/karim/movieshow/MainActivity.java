...
public class MainActivity extends AppCompatActivity {
  ...
  //  private int themeResource=R.style.AppTheme2;
            ...
            public void onSuccess(int page, List<Movie> movies) {
                ...
                if (adapter == null) {
                   adapter = new MoviesAdapter(movies, movieGenres, callback);
                    //adapter = new MoviesAdapter(movies, movieGenres,MainActivity.this);
...
//        PopupMenu themeMenu = new PopupMenu(this, findViewById(R.id.theme));
//        themeMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
//            @Override
//            public boolean onMenuItemClick(MenuItem item) {
//                switch (item.getItemId()) {
//                    case R.id.light:
//                      themeResource=R.style.AppTheme;
//                        recreate();
//                        return true;
//                    case R.id.darker:
//                        themeResource=R.style.AppTheme2;
//                        recreate();
//                        return true;
//                    default:
//                        return false;
...
//            }
//        });
//        themeMenu.inflate(R.menu.menu_change_theme);
//        themeMenu.show();
//    }
}
